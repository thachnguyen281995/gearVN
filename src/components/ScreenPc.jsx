...
import  datascreenpc  from "../data/datascreenpc";

import ScreenPcGaming from "../images/screenpcv2.png";

// Import Swiper styles

import { Link } from "react-router-dom";
const ScreenPc = () => {
    const products = datascreenpc.map((product) => {
        
        return (
            
            <div key={product.id}>
                <Link to={`/screenpc/${product.id}`}>
